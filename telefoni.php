...
<head>
    ...
    <link rel="stylesheet" href="telefoni_1.css"/>
    ...
    <section id="pubblicità">
        ...
        <div id="pubb_1" class="contenitore">
            ...
            <div class="contenitore_scritte">
                ...
                <div><strong>Dai slancio alla produttività con Google AI.</strong></div>
                <div><span>Cerchia qualsiasi elemento sullo schermo per fare una ricerca e saperne di più, 
                        usa la fotocamera per tradurre i menu, ottieni il riassunto di interi documenti con un tocco
            ...
            <div class="contenitore_img">
                ...
                <img src="media/pubb_telefoni_1.jpg">
        ...
        <div id="pubb_2" class="contenitore">
            ...
            <div class="contenitore_scritte">
                ...
                <div><strong>Grazie agli aggiornamenti garantiti fino a 7 anni, 
                    il tuo Pixel migliora con il passare del tempo.</strong></div>
                <div><span>Riceverai gli aggiornamenti del sistema operativo e della sicurezza, 
                    oltre ai rilasci di funzionalità, per un periodo fino a 7 anni, così potrai rendere più straordinarie le tue foto,
                     e non solo, con un pizzico di tranquillità in più.</span></div>

            </div>

            <div class="contenitore_img">

            <img src="media/pubb_telefoni_2.jpg">
