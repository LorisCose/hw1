    ...
    <section id="pubblicità">
        ...
        <div id="pubb_1" class="contenitore">
            ...
            <div class="contenitore_scritte">
                ...
                <div><strong>Tieni d'occhio ciò che conta davvero.
                    Dentro e fuori casa.</strong></div>
                <div><span>La videocamera Nest Cam alimentata a batteria funziona 
                    ovunque tu ne abbia bisogno, dal salotto al giardino.</span></div>

            </div>

            <div class="contenitore_img">

                <img src="media/pubb_smart_home_1.jpg">
        ...
        <div id="pubb_2" class="contenitore">
            ...
            <div class="contenitore_scritte">
                ...
                <div><strong>Un mondo di intrattenimento. Con un piccolo aiuto da Google.</strong></div>
                <div><span>Riproduci i tuoi contenuti preferiti con un'eccezionale risoluzione 4K o 1080p in HDR.</span></div>

            </div>

            <div class="contenitore_img">

            <img src="media/pubb_smart_home_2.jpg">
