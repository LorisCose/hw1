...
<head>
    <meta charset="UTF-8" />
    <title>Orologi</title>
    <link rel="stylesheet" href="orologi.css"/>
    ...
    <section id="pubblicità">
        ...
        <div id="pubb_1" class="contenitore">
            ...
            <div class="contenitore_scritte">
                ...
                <div><strong>In forma con Fitbit. Con l'aiuto di Google.</strong></div>
                <div><span>Una batteria potenziata da 24 ore con 
                    display sempre attivo e una ricarica più rapida.</span></div>

            </div>

            <div class="contenitore_img">

                <img src="media/pubb_orologi_2.jpg">
        ...
        <div id="pubb_2" class="contenitore">
            ...
            <div class="contenitore_scritte">
                ...
                <div><strong>Trasforma le informazioni in miglioramenti.</strong></div>
                <div><span>Monitoraggio del battito cardiaco fino al 40%
                     più preciso durante le attività intense come l'allenamento ciclismo.</span></div>

            </div>

            <div class="contenitore_img">

            <img src="media/pubb_orologi_1.jpg">
